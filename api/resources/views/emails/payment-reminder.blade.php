...
@section('section_label', 'Payment Reminder')
...
@section('content')
  ...
  <table cellpadding="0" cellspacing="0" border="0" width="100%"
    style="margin-bottom:24px;border:1px solid #F5C6A0;border-radius:6px;background-color:#FFF8F0;">
    <tr>
      <td style="padding:14px 20px;">
        <p style="margin:0;font-size:13px;font-weight:700;color:#B45309;">Outstanding Payment</p>
        <p style="margin:4px 0 0;font-size:12px;color:#92400E;line-height:1.6;">
          Invoice <strong>{{ $invoice->invoice_number }}</strong> was due on
          <strong>{{ $invoice->due_date->format('d M Y') }}</strong> and remains unpaid.
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr>
            ...
            <td width="50%" style="vertical-align:top;text-align:right;">
              ...
              <p style="margin:0 0 4px;font-size:12px;color:#717B99;">
                Due Date: <strong style="color:#B45309;">{{ $invoice->due_date->format('d M Y') }}</strong>
              </p>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          ...
          <tfoot>
            <tr style="background-color:#FFF8F0;">
              <td style="padding:12px 20px;font-size:14px;font-weight:700;color:#B45309;border-top:1px solid #DCDEE8;">Amount Outstanding</td>
              <td style="padding:12px 20px;font-size:14px;font-weight:700;color:#B45309;text-align:right;border-top:1px solid #DCDEE8;white-space:nowrap;">
                R {{ number_format($invoice->amount, 0, '.', ' ') }}
              </td>
            </tr>
          </tfoot>
    ...
    <tr>
      <td style="padding:14px 20px;">
        ...
        <p style="margin:0;font-size:12px;color:#717B99;line-height:1.6;">
          ...
          as the payment reference when making your EFT payment. If you have already made payment, please
