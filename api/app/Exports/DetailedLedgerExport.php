...
/**
 * WeConnectU "Detailed Customer Ledger" Excel export.
 *
 * Layout (matches WeConnectU exactly):
 *   Row 1  Community name              — 16pt bold, #dddddd fill across A:G
 *   Row 2  "Detailed Customer Ledger"  — 13pt bold
 ...
 *     (blank spacer)
 */
class DetailedLedgerExport implements FromArray, WithColumnWidths, WithEvents, WithTitle
{
    ...
    private array $borderBlocks  = [];   // [startRow, endRow] per customer section
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                // Thin borders around each customer's ledger block (heading → totals).
    ...
    {
        return 'Detailed Customer Ledger';
    }
}
