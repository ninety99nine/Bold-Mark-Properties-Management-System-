  ...
  <div class="space-y-4">
    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p v-if="countryStore.isMultiCountry" class="text-xs text-muted-foreground/70 mt-1">Rules apply only to communities in your currently selected region ({{ countryStore.activeCountryInfo?.name }}).</p>
      </div>
          ...
          <table class="w-full text-sm">
            <thead>
              <tr class="border-b border-border">
                ...
                <th class="text-left font-medium text-muted-foreground px-4 py-3 text-xs uppercase tracking-wide">Community</th>
                <th class="text-left font-medium text-muted-foreground px-4 py-3 text-xs uppercase tracking-wide">Owner / Occupant</th>
            ...
            <tbody>
              <tr
                ...
                @click="router.push(`/communities/${unit.community_id}`)"
              >
                <td class="px-4 py-3 font-medium text-foreground whitespace-nowrap">{{ unit.unit_number }}</td>
                <td class="px-4 py-3 text-muted-foreground whitespace-nowrap">{{ unit.community_name }}</td>
